...
vim.api.nvim_create_user_command("CreateLatexMatrix", function(opts) -- create a latex matrix at cursor with rows cols and env args.
    -- get args
...
vim.api.nvim_create_user_command("PromptLatexMatrix", function() -- prompt user for line and col and create matrix at cursor
    -- get user input
    ...
    vim.cmd("CreateLatexMatrix " .. tostring(cols) .. " " .. tostring(rows) .. " " .. env)
end, {})
...
vim.api.nvim_create_user_command("CreateLatexCycle", function(opts) -- create a len cycle with spacing dividers (default \quad)
    -- get args
...
vim.api.nvim_create_user_command("PromptLatexCycle", function() -- prompt user for line and col and create matrix at cursor
    -- get user input
...
vim.api.nvim_create_user_command("PromptLatexList", function() -- prompt user for line and col and create matrix at cursor
    -- get user input
...
vim.api.nvim_create_user_command("PromptLatexSurroundWrap", function() -- prompt user for line and col and create matrix at cursor
    -- get user input
