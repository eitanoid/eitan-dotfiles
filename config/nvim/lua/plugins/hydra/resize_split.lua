		...
		hint = {
			...
			funcs = {
				...
				down = function()
					...
					return (hsplit or height ~= vim.o.lines - 3)
							and ("%8s"):format(vim.o.lines - height - (hsplit and 4 or 2))
						or ""
				end,
				...
				right = function()
					...
					local width = vim.fn.winwidth(0)
					return (vsplit and width < vim.o.columns) and ("%s"):format(vim.o.columns - vim.fn.winwidth(0) - 1)
						or ""
				end,
			},
		},
